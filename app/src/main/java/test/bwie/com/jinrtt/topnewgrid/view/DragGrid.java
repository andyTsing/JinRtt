package test.bwie.com.jinrtt.topnewgrid.view;
...
import test.bwie.com.jinrtt.topnewgrid.tools.DataTools;
...
public class DragGrid extends GridView {
	...
	public DragGrid(Context context, AttributeSet attrs, int defStyleAttr, int downX) {
		super(context, attrs, defStyleAttr);
		this.downX = downX;
	}
	public DragGrid(Context context, int downX) {
		super(context);
		this.downX = downX;
	}
