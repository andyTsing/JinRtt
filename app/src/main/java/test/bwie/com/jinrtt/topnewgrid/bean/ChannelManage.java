package test.bwie.com.jinrtt.topnewgrid.bean;
...
import test.bwie.com.jinrtt.topnewgrid.dao.ChannelDao;
...
public class ChannelManage {
	...
	static {
		...
		defaultOtherChannels.add(new ChannelItem(8, "科技", 1, 0));
		defaultOtherChannels.add(new ChannelItem(9, "财经", 2, 0));
		defaultOtherChannels.add(new ChannelItem(10, "时尚", 3, 0));
		defaultOtherChannels.add(new ChannelItem(11, "八卦", 4, 0));
	}
